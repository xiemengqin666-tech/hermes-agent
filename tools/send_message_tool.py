...
# Weixin native IDs: wxid/gh/etc., group chatrooms, iLink DM peers such as
# o9...@im.wechat, and filehelper. Treat them as explicit targets; otherwise
# they fall through to home-channel resolution and may silently route wrong.
